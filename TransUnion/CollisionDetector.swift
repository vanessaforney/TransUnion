...
class CollisionDetector {
    ...
    static func calculateCollision(contact: SKPhysicsContact) -> (NSInteger, SKNode)? {
    ...
    internal static func checkCar(contact: SKPhysicsContact) -> (NSInteger, SKNode)? {
        var obj:SKNode! = nil
    ...
    internal static func checkMarriage(contact: SKPhysicsContact) -> (NSInteger, SKNode)? {
        var obj:SKNode! = nil
        var score:NSInteger = 0
    ...
    internal static func checkMoney(contact: SKPhysicsContact) -> (NSInteger, SKNode)? {
        var obj:SKNode! = nil
        var score:NSInteger = 0
    ...
    internal static func checkUnexpected(contact: SKPhysicsContact) -> (NSInteger, SKNode)? {
        var obj:SKNode! = nil
        var score:NSInteger = 0
